    ...
    <ul class="navbar-nav mr-auto">
      ...
      <li class="nav-item dropdown">
        ...
        <div class="dropdown-menu" aria-labelledby="navbarDropdown">
          <a class="dropdown-item" href="index.jsp?category=1">Laptop</a>
          <a class="dropdown-item" href="index.jsp?category=2">Mobile</a>
          <a class="dropdown-item" href="index.jsp?category=3">Television</a>
          <a class="dropdown-item" href="index.jsp?category=4">Headphone</a>
